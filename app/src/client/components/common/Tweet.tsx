...
export default function Tweet({
  ...
  return (
    <div className="tweet rounded-lg border border-slate-200 dark:border-slate-800 px-6 py-4 my-4 w-full bg-white dark:bg-slate-900">
      ...
      <div className="mt-4 mb-1 leading-normal whitespace-pre-wrap text-lg !text-slate-700 dark:!text-slate-300">
        {formattedText}
      </div>
      {media && media.length ? (
        <div

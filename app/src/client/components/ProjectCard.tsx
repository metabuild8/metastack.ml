export default function ProjectCard({ title, description, href, icon }) {
  return (
    ...
    >
      <div className="flex items-center border border-slate-200 dark:border-slate-800 rounded p-4">
        {icon == "react2025" && (
          <div className="h-8 w-8 ml-2 mr-4">
            <span className="sr-only">React 2025</span>
            <svg
              className="h-8 w-8 min-w-sm text-slate-900 dark:text-slate-100"
              viewBox="0 0 267 305"
            >
              <g fill="currentColor">
        ...
        {icon == "nextjs" && (
          <div className="h-8 w-8 ml-2 mr-4">
            ...
            <svg
              className="h-8 w-8 min-w-lg text-slate-900 dark:text-slate-100"
        ...
        <div>
          ...
          <p className="leading-5 text-slate-700 dark:text-slate-300">
            {description}
          </p>
        </div>
      </div>
